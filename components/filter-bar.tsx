 ...
 * both expose the same controls (status, type, priority, labels, epic, origin)
 * + archived. Purely presentational: `labelOptions` and `epicOptions` are the
 * data-derived facets (the rest come from static enums) and are passed in
 * rather than read from context here.
 */
